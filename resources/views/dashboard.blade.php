<x-app-layout>
    <div class="container mx-auto flex gap-0 lg:gap-20">
        <div class="isian-kiri lg:pt-[145px] pt-0">
            ...
            <div class="flex gap-5 pt-[40px] max-sm:justify-center">
                ...
                <button class="flex items-center text-[#74A512] text-sm">Explore Our Blog <img class="pl-2" src="{{asset('isian/panah.svg')}}" alt=""></button>
            </div>
        </div>
        <div>
            <img class="pt-16" src="{{asset('isian/makanan1.png')}}" alt="">
        </div>
    </div>
    <div class="container mx-auto pt-20 flex lg:justify-center justify-center">
        <div>
            ...
            <img class="" src="{{asset('isian/partner.svg')}}" alt="">
        </div>
    </div>
    ...
    <div class="container mx-auto  pt-[140px]">
        <div class="grid lg:grid-cols-2 lg:grid-rows-1 grid-cols-1 grid-rows-2">
            <div class="makan flex bg-[#EAF9CE] w-[375px] h-[200px] lg:w-[620px] lg:h-[230px] items-center">
                <img class="w-[137px] h-[100px] lg:w-[252px] lg:h-[215px]" src="{{asset('isian/fastfood.svg')}}" alt="">
            ...
            <div class="makan flex bg-[#FFF7E2] w-[375px] h-[200px] lg:w-[620px] lg:h-[230px] items-center">
                <img class="w-[200px] h-[100px] lg:w-[252px] lg:h-[215px]" src="{{asset('isian/organicfood.svg')}}" alt="">
                <div class="pl-2 text-left">
    ...
    <div class="container mx-auto pt-28">
        <div class="flex justify-between">
            ...
            <img class="max-sm:w-[205px]" src="{{asset('isian/burger2.svg')}}" alt="">
        </div>
    </div>
    <div class="container mx-auto pt-28">
        <div class="flex justify-between">
        ...
        <div>
            ...
            <div id="jualan" class="grid lg:grid-cols-4 lg:grid-row-2 grid-cols-2 pt-16 gap-5">
                <div class="makan">
                    <img class="w-full" src="{{asset('isian/produk1.svg')}}" alt="">
                    <div class="flex justify-between">
                        <div>
                            <h2 class="font-bold text-xl">Cucumber</h2>
                        </div>
                        <div class="flex">
                            <img class="w-4" src="{{asset('isian/star.svg')}}" alt="">
                            <p>(2.1)</p>
                        </div>
                    </div>
                        ...
                        <div class="flex justify-between pt-7">
                            <div class="flex">
                                <img src="{{asset('isian/add.svg')}}" alt="">
                ...
                <div class="makan" >
                    <img class="w-full" src="{{asset('isian/produk2.svg')}}" alt="">
                    <div class="flex justify-between">
                        <div>
                ...
                <div  class="makan">
                    <img class="w-full" src="{{asset('isian/produk3.svg')}}" alt="">
                    <div class="flex justify-between">
                        <div>
                ...
                <div  class="makan">
                    <img class="w-full" src="{{asset('isian/produk4.svg')}}" alt="">
                    <div class="flex justify-between">
                        <div>
    ...
    <div class="container mx-auto lg:pt-28 lg:p-10 p-5 bg-[#FFF7E2] relative mt-36 ">
        <div class="flex justify-between lg:pl-20 pl-0">
            ...
            <img src="{{asset('isian/kentang.svg')}}" alt="" class=" lg:w-[680px] w-[230px] absolute lg:right-10 right-0 top-20 ">
        </div>
    </div>
            ...
            <div class="flex flex-col lg:flex-row justify-center gap-6 text-white h-30">
                ...
                <div>
                    <div class="flex gap-3 align-center items-center mb-10">
                        <img src="{{asset('isian/Logo.svg')}}" alt="">
